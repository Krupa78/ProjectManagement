...
namespace ProjectManagement.Dialogs
{
    ...
    public class PlannedStartDateDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            context.Wait(this.GetPlannedStartDate);
        }

        public async Task GetPlannedStartDate(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (userData != null && userData.Data != null)
            {
                ...
                if (token != null)
                {
                    ...
                    await context.PostAsync($"Planned start date for {details.ResponseJSON.ProjName} is **{details.ResponseJSON.PlannedStartDate.ToLongDateString()}**");
                    context.Done(true);
                }
                else
                {
