...
{
    [Serializable]
    public class ActualEndDateDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            context.Wait(this.GetActualEndDate);
        }

        public async Task GetActualEndDate(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (userData != null && userData.Data != null)
            {
                ...
                if (token != null)
                {
                    ...
                    await context.PostAsync($"Actual end date for {details.ResponseJSON.ProjName} is **{details.ResponseJSON.EndDate.ToLongDateString()}**");
                    context.Done(true);
                }
                else
                {
