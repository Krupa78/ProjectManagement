...
{
    [Serializable]
    public class ProjectStatusDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            context.Wait(this.GetProjectStatus);
        }

        public async Task GetProjectStatus(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (userData != null && userData.Data != null)
            {
                ...
                if (token != null)
                {
                    ...
                    await context.PostAsync($"Status of {details.ResponseJSON.ProjName} is {details.ResponseJSON.ProjStatus}");
                    context.Done(true);
                }
                else
                {
