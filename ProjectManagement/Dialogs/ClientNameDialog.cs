...
{
    [Serializable]
    public class ClientNameDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            context.Wait(this.GetClientName);
        }

        public async Task GetClientName(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (userData != null && userData.Data != null)
            {
                ...
                if (token != null)
                {
                    ...
                    await context.PostAsync($"Client for {details.ResponseJSON.ProjName} is **{details.ResponseJSON.CompanyName}**");
                    context.Done(true);
                }
                else
                {
