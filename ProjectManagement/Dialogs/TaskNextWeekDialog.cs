...
{
    [Serializable]
    public class TaskNextWeekDialog : IDialog<object>
    {
        ...
        public async Task ResumeAfterForm(IDialogContext context, IAwaitable<CompletedRemainingTaskForm> result)
        {
            ...
            {
                await context.PostAsync("Remaining Task for next week:: \n" + "1. ICR-1 Develop login page. \n" + "2. ICR-2 Develop home page.");
                context.Done(true);
            }
            else
            {
                await context.PostAsync("Completed Task for next week:: \n" + "1. ICR-1 Develop login page. \n" + "2. ICR-2 Develop home page.");
                context.Done(true);
            }
        }
    }
