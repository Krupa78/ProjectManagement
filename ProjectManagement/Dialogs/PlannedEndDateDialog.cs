...
{
    [Serializable]
    public class PlannedEndDateDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            context.Wait(this.GetPlannedEndDate);
        }

        public async Task GetPlannedEndDate(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (userData != null && userData.Data != null)
            {
                ...
                if (token != null)
                {
                    ...
                    await context.PostAsync($"Planned end date for {details.ResponseJSON.ProjName} is **{details.ResponseJSON.PlannedStartDate.ToLongDateString()}**");
                    context.Done(true);
                }
                else
                {
